"""
Internal utility helpers used by the chaocrdantic pipeline.
"""
...
def scale_to_fit(
    ...
    """Resize to the model grid while respecting the original aspect ratio."""
...
def detect_repeat_token(
    ...
    """Detect degenerate repeated-token tails in model output."""
    if cut_from_end > 0:
